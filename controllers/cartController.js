...
const  addCart=async(req,res)=>{
    ...
    try {
        ...
        const exisitingcartitem= cart.products.find((item => item.productId.toString() === product._id.toString()))
...
const loadCart=async(req,res)=>{
    ...
    try {
            ...
            if(cart){
                ...
                res.render('userCart',{user:userData,products:products,wishlistCount})
            }
            else{
...
const updateQuantity = async (req, res) => {
    try {
        ...
        const totalSubtotal = cart.products.reduce((acc, item) => acc + item.subtotal);
