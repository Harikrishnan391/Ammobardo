...
const { ItemAssignmentInstance } = require('twilio/lib/rest/numbers/v2/regulatoryCompliance/bundle/itemAssignment');
...
const loadaddProduct=async(req,res)=>{
    ...
    try {
        ...
        res.render('addProduct',{category:categories,user:req.session.user_id?req.session.user_id:null})
