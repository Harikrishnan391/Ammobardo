...
admin_route.get('/add-coupon',Adminauth.isLogin, couponControllerN.addNewCouponGET);
admin_route.post('/add-coupon', Adminauth.isLogin,couponControllerN.addNewCouponPOST);
